...
const AboutMe = () => {
    ...
    return (
        <div className='text-white bg-black text-center flex flex-col md:w-1/2 md:justify-evenly items-center bg-gradient-radial from-gradiant1 from-30% via-gradiant2 via-80% to-gradiant3 to-30%'>
