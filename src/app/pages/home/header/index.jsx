...
export default function Header(){
    ...
    return (
        <div className="h-screen w-full " onLoad={()=>context.setIsHome(true)}>
            <video  autoPlay={true} loop muted className=' w-full h-full object-cover'>
                <source src='/assets/videoDesktopBg.mp4' type='video/mp4'/>
                <div className='bg-dark/40 w-full h-full   flex justify-center items-center flex-col  z-10'>
