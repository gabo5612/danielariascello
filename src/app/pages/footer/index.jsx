    ...
    <div className='bg-footerBg bg-cover bg-bottom h-[70dvh] mt-[-2px]'>
        ...
        <div className="flex flex-col justify-between h-4/6">
            ...
            <div className="flex justify-center items-center gap-4">
                <a href="#" className="cursor-pointer"><Image src='/assets/youtube.svg' alt="" width={35} height={35} loading="lazy"/></a>
                <a href="#" className="cursor-pointer"><Image src='/assets/ig.svg' alt="" width={25} height={25} loading="lazy"/></a>
                <a href="#" className="cursor-pointer"><Image src='/assets/fb.svg' alt="" width={25} height={25} loading="lazy"/></a>
                <a href="#" className="cursor-pointer"><Image src='/assets/tiktok.svg' alt="" width={25} height={25} loading="lazy"/></a>
            </div>
            <div className="flex flex-col items-center justify-center gap-4 text-primary-white font-lora text-l">
                <Link href='/biography'>{context.text.biography}</Link>
